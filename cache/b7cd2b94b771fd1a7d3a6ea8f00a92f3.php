...
<html lang="it">
    ...
    <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" href="/">Sensorario</a>
            <div class="nav-collapse collapse">
                <ul class="nav">
                    <li class="active"><a href="/">Home</a></li>
                    <li><a href="/manual">Manual</a></li>
                    <li><a href="/contatti/contacts">Contact</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="/contatti/contacts">Contatti</a></li>
                            <li><a href="/blog/dashboard">Blog</a></li>
                        </ul>
                    </li>
                </ul>
    ...
    <div class="hero-unit">
        <h1>Contattaci!</h1>
        <ul>
            <li>Email: sensorario@gmail.com</li>
            <li>Cellulare: +39 349 2893030</li>
        </ul>
    </div>
</div>
